...
public class PercGen {
    ...
    public static final String TRAIN_NAME = "practice_2/mnist/train.imgs",
            LABELS_NAME = "practice_2/mnist/labels.imgs", RESULT = "out.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        // n x m
        double[][][] omega = new double[10][n][m];
